...
const OrderPage = () => {
  ...
  // Enhanced mock data with more realistic e-commerce data
  const mockOrders = [
    {
      _id: "1",
      ...
      products: [
        {
          ...
          price: 3799,
          originalPrice: 4299,
          variantId: { storage: "256GB", color: "Natural Titanium" },
      ...
      products: [
        {
          ...
          price: 2499,
          originalPrice: 2999,
          variantId: { color: "Midnight Black" },
      ...
      products: [
        {
          ...
          price: 549.5,
          originalPrice: 599.5,
          variantId: { color: "Graphite Black", size: "Universal" },
          warranty: "1 Year Brand Warranty",
        },
      ],
      shippingAddress: {
        fullName: "Rahul Kumar",
        addressLine1: "Flat 301, Prestige Lakeside",
    ...
    },
    {
      ...
      cancelledAt: "2025-08-11T10:30:00Z",
      priority: "Express",
      refundAmount: 5499,
      ...
      products: [
        {
          ...
          price: 4999,
          originalPrice: 5999,
          variantId: { size: "27 inch", resolution: "1440p", refresh: "240Hz" },
          warranty: "3 Year Comprehensive Warranty",
        },
      ],
      shippingAddress: {
        fullName: "Vikash Singh",
        addressLine1: "C-204, Tech Park One",
    ...
    const matchesSearch =
      ...
      order.products.some(
        (p) =>
          ...
          p.productId.brand.toLowerCase().includes(searchTerm.toLowerCase())
      );
    const matchesStatus =
      ...
      <div className="bg-white rounded-2xl max-w-5xl w-full max-h-[95vh] overflow-y-auto shadow-2xl">
        ...
        <div className="p-6 space-y-8">
          ...
          <div>
            ...
            <div className="grid gap-4">
              {order.products.map((product, index) => (
                <div
                  key={index}
                  className="flex items-center space-x-4 p-4 bg-gray-50 rounded-xl border border-gray-200 hover:shadow-md transition-shadow"
                >
                  <img
                  ...
                  <div className="flex-1">
                    ...
                    {product.variantId && (
                      <p className="text-sm text-gray-600">
                        {Object.entries(product.variantId)
          ...
          <div className="flex flex-wrap gap-3 pt-6 border-t border-gray-200">
            <button className="flex-1 sm:flex-none bg-blue-600 text-white px-6 py-3 rounded-xl hover:bg-blue-700 transition-colors flex items-center justify-center space-x-2 font-medium">
            ...
            <div className="bg-gray-50 rounded-xl p-4 space-y-4">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <div className="relative">
                  ...
                  <select
                    className="pl-10 pr-8 py-2 bg-white border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                    value={statusFilter}
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-12 text-center">
            <div className="max-w-md mx-auto">
              ...
              {searchTerm || statusFilter !== "All" || dateRange !== "all" ? (
                ...
                <button className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-200 transform hover:scale-105 shadow-lg">
                ...
                <div className="p-6 pb-4">
                  ...
                  <div className="space-y-3">
                    ...
                    {order.products.length > (viewMode === "grid" ? 1 : 2) && (
                      <p className="text-sm text-blue-600 font-medium pl-20">
                        +{order.products.length - (viewMode === "grid" ? 1 : 2)}{" "}
                        more items
                      </p>
                    )}
                ...
                <div className="px-6 py-4 bg-gray-50 border-t border-gray-100">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex flex-col space-y-2">
                      ...
                      {order.trackingId && (
                        <button className="bg-gray-100 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-200 transition-colors flex items-center space-x-2 text-sm font-medium">
