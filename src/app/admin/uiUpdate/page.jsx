  ...
  const fetchBanners = async () => {
    try {
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_SERVER}/api/admin/banners`,
        {
  ...
  const handleBannerUpload = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_SERVER}/api/admin/banners/update`,
        formData,
        {
          headers: {
  ...
  const handleDeleteBanner = async (bannerUrl) => {
    try {
      ...
      const response = await axios.delete(
        `${process.env.NEXT_PUBLIC_SERVER}/api/admin/banners/delete`,
        { data: { bannerUrl } }
      );
